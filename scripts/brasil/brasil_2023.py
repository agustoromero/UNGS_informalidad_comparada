...
if __name__ == "__main__":
    run_country_year("brasil", 2023)
"""Pipeline brasil 2023.
...
def load_data() -> pd.DataFrame:
    """Leer microdatos desde data/brasil (OneDrive/local sync)."""
    raise NotImplementedError("Definir lectura específica para BRASIL 2023")
